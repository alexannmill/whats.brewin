        ...
        <div className="info-container">
          <div>
            <div className="brewer-address">
              <h1><FontAwesomeIcon icon={faMapLocationDot}/> {brewer.street_number}{brewer.street}</h1>
              <h1>{brewer.state_prov}, USA, {brewer.post_zip}</h1>
            </div>
            <br/>
            <div className="brewer-contact">
              <a target="_blank" href={brewer.website}><FontAwesomeIcon icon={faGlobe}/> {brewer.website}</a>
              <h1> <FontAwesomeIcon icon={faPhone}/> {brewer.phone}</h1>
            </div>
        </div>
      </div>
          <Link to="brewer/edit">
